...
def remove_edges_of_weigth_k(graph, k):
...
def shrinking_components_nodes(author_network, g_type, n,
    ...
    clustering_w = [nx.average_clustering(graph.to_undirected(),
                    weight="weight")]
    for k in range(1, n + 1):
        ...
        clustering.append(nx.average_clustering(graph.to_undirected(),
                          weight=None))
        clustering_w.append(nx.average_clustering(graph.to_undirected(),
                            weight="weight"))
